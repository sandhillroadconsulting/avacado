      ...
      <main className="relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right Column - Map */}
            <div className="relative">
              <div className="absolute -inset-2 sm:-inset-4 lg:-inset-8 border-2 border-avocado opacity-20" style={{
              ...
              <div className="absolute top-0 left-0 w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 border-l-2 border-t-2 border-avocado opacity-40"></div>
              <div className="absolute top-0 right-0 w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 border-r-2 border-t-2 border-avocado opacity-40"></div>
              <div className="absolute bottom-0 left-0 w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 border-l-2 border-b-2 border-avocado opacity-40"></div>
              <div className="absolute bottom-0 right-0 w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8 border-r-2 border-b-2 border-avocado opacity-40"></div>
